 ...
 */
            ...
            function initData(vm) {
                ...
                while (i--) {
                    if (props && hasOwn(props, keys[i])) {
                        "production".NODE_ENV !== "production" && warn('The data property "' + keys[i] + '" is already declared as a prop. ' + "Use prop default value instead.", vm);
            ...
            function _createElement(context, tag, data, children, normalizationType) {
                if (isDef(data) && isDef(data.__ob__)) {
                    "production".NODE_ENV !== "production" && warn("Avoid using observed data object as vnode data: " + JSON.stringify(data) + "\n" + "Always create fresh vnode data objects in each render!", context);
